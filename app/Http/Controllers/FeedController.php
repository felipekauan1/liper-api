...
class FeedController extends Controller
{
    ...
    public function read(Request $request)
    {
        ...
        $users = [];
        $usersList = UserRelation::where('user_from', $this->loggedUser['id'])->get();
    ...
    public function userFeed(Request $request, $id = false)
    {
        ...
        $postList = Post::where('id_user', $id)->orderBy('created_at', 'desc')->offset($page * $perPage)->limit($perPage)->get();
    ...
    public function userPhotos(Request $request, $id = false)
    {
        ...
        $postList = Post::where('id_user', $id)->where('type', 'photo')->orderBy('created_at', 'desc')->offset($page * $perPage)->limit($perPage)->get();
